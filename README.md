...
The Addon:
1. Download the [latest version](www.google.com) and extract the folder inside into your addons folder, like this: `World of Warcraft\Interface\AddOns\BiSTracker`
