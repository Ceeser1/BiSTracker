...
**Why do I set an Account Alias instead of my real account name?**
The alias only labels groups in the sheet. **Never use your real account name** : it's not needed and shouldn't be shared.
